...
echo 'array is read'
/topofit/evaluate --subjs /data/users2/washbee/speedrun/topofit-data/${a[${SLURM_ARRAY_TASK_ID}]} --hemi lh --model /data/users2/washbee/speedrun/topofit/output2/lh.2175.pt
